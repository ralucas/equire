...
(function() {
  var GoogleStrategy, Issue, IssueSchema, User, UserSchema, app, db, express, findOrCreate, fs, http, io, mongoose, passport, path, routes, server, socketio, util;
