...
(function() {
  var GoogleOauthStrategy, GoogleStrategy, Issue, IssueSchema, Lesson, LessonSchema, MongoURL, User, UserSchema, app, childProcess, client, express, fs, http, io, ip, local, moment, momentTZ, mongoose, passport, path, routes, server, socketio, sys, timeZone, util, _, _ref, _ref1;
  ...
  ip = (_ref1 = process.env.IP) != null ? _ref1 : local;
