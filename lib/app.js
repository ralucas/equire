...
(function() {
  var GoogleStrategy, Issue, IssueSchema, User, UserSchema, app, client, db, exec, express, fs, http, io, moment, mongoose, passport, path, puts, routes, server, socketio, sys, util;
