...
(function() {
  var GoogleStrategy, Issue, IssueSchema, MongoURL, User, UserSchema, WebSocket, WebSocketServer, app, childProcess, client, express, fs, http, io, ip, moment, mongoose, passport, path, routes, server, socketio, sys, util, wss, _, _ref, _ref1;
  ...
  */
  ...
  wss.on('connection', function(ws) {
    ...
    id = setInterval(function() {
      return ws.send(JSON.stringify(new Date()), function() {});
    }, 1000);
