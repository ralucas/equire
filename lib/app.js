...
(function() {
  var GoogleStrategy, Issue, IssueSchema, Lesson, LessonSchema, MongoURL, User, UserSchema, app, childProcess, client, express, fs, http, io, ip, moment, momentTZ, mongoose, passport, path, routes, server, socketio, sys, timeZone, util, _, _ref, _ref1;
