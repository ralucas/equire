...
(function() {
  var GoogleStrategy, Issue, IssueSchema, MongoURL, User, UserSchema, app, childProcess, client, express, fs, http, io, ip, moment, mongoose, passport, path, routes, server, socketio, sys, util, _, _ref, _ref1;
