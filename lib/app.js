...
(function() {
  var GoogleStrategy, Issue, IssueSchema, Lesson, LessonSchema, MongoURL, User, UserSchema, app, childProcess, client, express, fs, http, io, ip, linkmOff, moment, momentTZ, mongoose, passport, path, routes, server, socketio, sys, timeZone, util, _, _ref, _ref1;
  ...
  linkmOff = childProcess.exec('~/linkm/./linkm-tool --off', function(error, stdout, stderr) {
